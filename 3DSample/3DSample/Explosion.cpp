...
void Framework::Explosion::PreInitialize()
{
	...
	shp_collisionRect = ObjectFactory::Create<Collision2D_Rectangle>(std::make_shared<Rectangle>(100, 100, transform->GetPosition().GetVector2(), Rectangle::GetRectangleOuterCircleRadius(16, 16)), GetThis<GameObject>());
...
Framework::EnemyExplosion::EnemyExplosion(std::shared_ptr<Transform> shp_arg_transform, std::shared_ptr<GameObjectManager> shp_arg_gameObjectManager)
	:Bullet(0, 0, shp_arg_transform, shp_arg_gameObjectManager) {
...
void Framework::EnemyExplosion::Hit(std::shared_ptr<GameObject> other)
{
...
void Framework::EnemyExplosion::PreInitialize()
{	//shp_texture = ObjectFactory::Create<Resource_Texture>("apple.png", transform, false, false);
	shp_collisionRect = ObjectFactory::Create<Collision2D_Rectangle>(std::make_shared<Rectangle>(100, 100, transform->GetPosition().GetVector2(), Rectangle::GetRectangleOuterCircleRadius(16, 16)), GetThis<GameObject>());

}

void Framework::EnemyExplosion::Initialize()
{
	{
